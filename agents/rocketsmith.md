...
│   └── assets/
│       ├── stl/               ← STL meshes (3D viewer)
│       ├── png/               ← isometric PNG thumbnails
│       ├── gif/               ← 360° rotating isometric GIF animations
│       └── txt/               ← 360-frame ASCII loading animations (1°/frame)
...
- `cadsmith_generate_assets(step_file_path="<project_dir>/cadsmith/step/nose_cone.step", project_dir="<project_dir>")` — writes to gui/assets/png/, gif/, txt/
