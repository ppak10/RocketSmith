...
├── cadsmith/                  ← CAD scripts, geometry, and meshes
...
```
Bash("mkdir -p <project_dir>/cadsmith/source <project_dir>/cadsmith/step <project_dir>/cadsmith/stl <project_dir>/prusaslicer/config <project_dir>/prusaslicer/gcode <project_dir>/gui/parts <project_dir>/gui/assets/png <project_dir>/gui/assets/gif <project_dir>/gui/assets/txt <project_dir>/gui/progress <project_dir>/gui/logs")
```
