...
- **Unit conversion.** The manifest's feature blocks are already in millimetres. The DFAM skill calls `openrocket_component` (action="read") which handles the metre → millimetre conversion.
