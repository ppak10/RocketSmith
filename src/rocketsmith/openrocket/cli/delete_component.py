...
def register_openrocket_delete_component(app: typer.Typer):
    ...
    def openrocket_delete_component(
        ...
        component_name: Annotated[
            str,
            typer.Argument(help="Name of the component to delete (as shown by inspect)."),
        ],
        ...
        """Remove a component from an .ork file by name."""
        ...
        try:
            deleted = delete_component(ork_path, component_name, jar)
        ...
        rprint(f"✅ Deleted [cyan]{deleted}[/cyan] from [cyan]{ork_path.name}[/cyan]")
