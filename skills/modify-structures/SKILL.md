...
1. **Re-render**: `cadsmith_generate_preview(step_file_path=<step_path>)`. The tool auto-routes to `parts/png/<name>.png`, overwriting the Pass 1 render — the modified version is the current truth.
